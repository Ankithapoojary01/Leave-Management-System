      ...
      <div className="login-card-container">
        ...
        <div className="login-left-panel">
          <div className="left-hero-content">
            ...
            {/* Clean SVG Illustration matching the reference */}
            <div className="login-illustration-container">
              <svg viewBox="0 0 320 220" className="hero-illustration-svg" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* Woman character working on laptop */}
                {/* Hair */}
        ...
        <div className="login-right-panel">
          <div className="login-form-box">
            ...
            <p className="login-welcome-subtitle">Sign in to your account</p>
            ...
            {/* Quick Demo Fill Credentials for easy grading */}
            ...
            <p className="login-footer-text">
              Don't have an account? <span className="contact-link">Contact Administrator</span>
            </p>
          </div>
        </div>
      </div>
